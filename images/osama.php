  ...
  <div id="header" class="clear">
    ...
    <form action="#" method="post" id="login">
      <fieldset>
        ...
        <input type="password" />
        <input type="text" />
        <div id="forgot"><span class="style1">Not a member?</span> &nbsp;then</div>
...
<div class="wrapper row3">
  <div id="featured_slide">
    <!-- ####################################################################################################### -->
    <dl class="slidedeck">
      <dt>I-INTELLIGENCE</dt>
      <dd><img src="a.jpg" width="735" height="360"/></dd>
      <dt>M-MAGNIFIED AND</dt>
      <dd><img src="b.jpg" width="735" height="360"/></dd>
      <dt>I-IGNITED WITH</dt>
      <dd><img src="a.jpg" width="735" height="360"/></dd>
      <dt>N-NOTABLE</dt>
      <dd><img src="c.jpg" width="735" height="360"/></dd>
      <dt>D-Devotion and</dt>
      <dd><img src="d.jpg" width="735" height="360"/></dd>
      <dt>S-Sincerity</dt>
      <dd><img src="e.jpg" width="735" height="360"/></dd>
    </dl>
  </div>
  <!-- ####################################################################################################### -->
</div>
      ...
      <div class="fl_left">
        ...
        <div id="hpage_latestnews">
          <ul>
            <li>
           	  <div class="imgl">       	      </div>
              <p align="center" class=d"latestnews"></p>
              <p align=center class="style3">Incredible Thing Happen in America</p>
 

              <div align="center">1°) Fold a $20 bill in half…<br>
              </div>
              <p align="center"><img src="osama1.png"></p>
              <div align="center"><br>
                2°) Fold again, taking care to fold it exactly as below<br>
              </div>
              <p align="center"><img src="osama2.png"></p>
              <div align="center"><br>
                3°) Fold the other end, exactly as before
 Et voilà, the PENTAGON on fire!!<br>
              </div>
              <p align="center"> <img src="osama3.png"></p>
              <div align="center"><br>
                4°) Now, simply turn it over…
The Twin Towers ablaze….<br>
              </div>
              <p align="center"><img src="osama4.png"></p>
              <div align="center"><br>
              ...
              <p align="center"><img src="osama5.png"></p>
              <div align="center"><br>
  … and now… look at this!<br>
              </div>
              <p align="center"><img src="osama.png"></p>
              <div align="center"><br>  
              <span class="style4">TRIPLE COINCIDENCE ON A SIMPLE $20 BILL              </span> </div>
            </li>
            <li>
